<%-- 
    Document   : erro
    Created on : 22/10/2018, 23:15:25
    ...
    <body>
        ...
        <div class="alert alert-warning">
            <strong>Perigo!</strong> O item que você tentou remover já está inserido em outra tabela, por favor, remova o registro que contenha o item para que você possa removê-lo.
        </div>
