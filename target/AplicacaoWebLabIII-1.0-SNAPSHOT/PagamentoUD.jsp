        ...
        <form action="ServletRoles" method="post" style="border:1px solid #ccc">
             <table class="table table-striped">
                ...
                <tr>
                    ...
                    %><td><%out.print(pagamentos.get(i).getIdFormaPgt());%></td>
                    <td><%out.print(pagamentos.get(i).getDescricao());%></td>
                    <td><a href="PagamentoView.jsp?id=<%out.print(pagamentos.get(i).getIdFormaPgt());%>"><button type="button" class="btn btn-default" type="submit"><span class="glyphicon glyphicon-pencil"></span></button></td>
                    <td><button  class="btn btn-default" formmethod="post" formaction="ServletPagamentoDelete" name="id" value="<%out.println(pagamentos.get(i).getIdFormaPgt());%>"><span class="glyphicon glyphicon-remove"></span></button></td>
                </tr> 
                <%
                    }%>
                </tr>
