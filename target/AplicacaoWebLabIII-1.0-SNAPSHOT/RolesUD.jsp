        ...
        <form style="border:1px solid #ccc">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    %><td><%out.print(roles.get(i).getIdRole());%></td>
                    <td><%out.print(roles.get(i).getDescription());%></td>
                    <td><a href="RolesView.jsp?id=<%out.print(roles.get(i).getIdRole());%>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></button></td>
                    <td><button type="submit" class="btn btn-default" formmethod="post" formaction="ServletRoleDelete" name="id" value="<%out.println(roles.get(i).getIdRole());%>"><span class="glyphicon glyphicon-remove"></span></button></td>
                </tr> 
                <%
                    }%>
                </tr>
