...
<body>
    ...
    <form action="ServletCategoria" method="post" style="border:1px solid #ccc">
        <div class="container">
            <h1>Cadastro de categorias</h1>
            <hr>

            <label for="email"><b>Descrição da categoria:</b></label>
            <input class="form-control" type="text" placeholder="Digite a descrição para essa categoria..." name="nome" required>
