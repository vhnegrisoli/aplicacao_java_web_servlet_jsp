...
<body>
    ...
    <form action="ServletTags" method="post" style="border:1px solid #ccc">
        <div class="container">
            <h1>Inserir tags</h1>
            <hr>

            <label for="email"><b>Descrição da tag</b></label>
            <input class="form-control" type="text" placeholder="Digite a descrição para essa tag..." name="nome" required>
