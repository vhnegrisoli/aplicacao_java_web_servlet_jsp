...
<html>
    ...
    <body>
        ...
        <form action="ServletRoles" method="post" style="border:1px solid #ccc">
            <div class="container">
                <h1>Cadastro de Papel</h1>

                <label for="email"><b>Descrição da função:</b></label>
                <input class="form-control" type="text" placeholder="Digite a descrição para essa função..." name="nome" required>
