...
<body>
    ...
    <form action="ServletPlanos" method="post" style="border:1px solid #ccc">
        <div class="container">
            <h1>Cadastro de planos</h1>
            <hr>

            <label for="email"><b>Descrição do plano:</b></label>
            <input class="form-control" type="text" placeholder="Digite a descrição para esse plano..." name="nome" required>
            <label for="email"><b>Preço do plano:</b></label>
            <input class="form-control" type="text" placeholder="Digite o preço para esse plano..." name="preco" required>
